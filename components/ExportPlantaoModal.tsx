...
export default function ExportPlantaoModal({ visible, onClose }: Props) {
    ...
    const handleExport = async () => {
        ...
        setLoading(true);
        try {
            await plantaoService.exportPdf(formatDateToISO(startDate), formatDateToISO(endDate));
            onClose();
        } catch (e: any) {
            ...
            <View style={styles.overlay}>
                <View style={[styles.card, isDark ? styles.cardDark : styles.cardLight]}>
                    <View style={[styles.iconContainer, { backgroundColor: '#f59e0b18' }]}>
                        <FontAwesome5 name="file-pdf" size={28} color="#f59e0b" />
                    </View>
                    <Text style={[styles.title, isDark && styles.textDark]}>Exportar Plantão</Text>
                    ...
                    <View style={styles.dateRow}>
                        <View style={styles.dateField}>
                            ...
                            >
                                <FontAwesome5 name="calendar-alt" size={14} color="#f59e0b" />
